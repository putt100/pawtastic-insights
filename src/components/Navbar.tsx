              ...
              {isAuthenticated ? (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56 bg-white p-2">
                    ...
                    <DropdownMenuSeparator />
                    {user?.walletAddress && (
                      <DropdownMenuItem className="cursor-default flex-wrap break-all">
                  ...
                  <>
                    <div className="flex items-center gap-3 py-2">
                      {user?.avatar ? (
                        ...
                        <div className="w-8 h-8 rounded-full bg-pawlingo-primary/10 flex items-center justify-center">
                      ...
                      <div>
                        ...
                        {user?.walletAddress && (
                          <div className="text-xs text-pawlingo-muted truncate max-w-[180px]">
                            {user.walletAddress.substring(0, 6)}...{user.walletAddress.substring(user.walletAddress.length - 4)}
                          </div>
                        )}
                      </div>
                    </div>
                    <Button className="w-full rounded-full" variant="outline" onClick={() => { setIsMobileMenuOpen(false); }}>
                      Pet Dashboard
                    </Button>
