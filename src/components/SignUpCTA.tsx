          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-center">
                ...
                <Button className="rounded-full py-7 px-8 bg-gradient-to-r from-pawlingo-primary to-pawlingo-secondary text-white hover:shadow-lg hover:shadow-pawlingo-primary/20 transition-all">
                  Try PawLingo Free for 14 Days
